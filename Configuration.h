...
#define LINKAGE1 155 //mm  主臂长度    Preprocessor cannot handle decimal point...
// Length of outer support arm     Measure arm lengths precisely and enter 
#define LINKAGE2 180 //mm 副臂长度   

#define CENCER_OFFSET 65 //mm  旋转轴偏移量
#define HEAD_OFFSET 50 //mm    头部偏移量

// SCARA tower offset (position of Tower relative to bed zero position) 
// This needs to be reasonably accurate as it defines the printbed position in the SCARA space.
#define SCARA_OFFSET_X 280 //mm   
#define SCARA_OFFSET_Y 0 //mm
#define SCARA_OFFSET_Z -45 //mm
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {444.444,444.444,444.444,157}  // default steps per unit for SCARA
